...
- **Missing:** `empirical_*` calibration fields + author blend by N + JMLE (3.4); BKT + heatmap mastery coloring (3.5); `questions_pending_review` + `question_versions` + review UI, confidence 1–4 decision (3.6).
