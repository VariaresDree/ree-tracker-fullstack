// src/config/formulaSeed.js
// Bundled offline SEED for the Formula Matrix. Lives in a plain config module
// (not the ReferenceHub component) so both the component and useReferenceData can
// import it without a circular dependency. useReferenceData merges any admin DB
// rows on top of this; the admin "Import bundled library" action can promote
// these into editable DB entries. Always available offline (ships in the bundle).
export const OFFLINE_FORMULAS = {
    Mathematics: [
